...
Using structured policy documents (like [`Cross-Border-Transaction-Fraud-Detection-Compliance-Policy.md`](files/Cross-Border-Transaction-Fraud-Detection-Compliance-Policy.md)) as input provides:
...
[Report Bug](https://github.com/DecisionsDev/odm-ai-toolkit/issues) · [Request Feature](https://github.com/DecisionsDev/odm-ai-toolkit/issues) · [Documentation](docs/)
